// ============================================
// CreateEventDto — the form details for posting an announcement or event.
// A DTO is a simple 'data parcel' the website sends to the server.
// This one carries the title, message, date, type, and who should see it.
// ============================================
using System.ComponentModel.DataAnnotations;

namespace AlmanahilAPI.DTOs;

// Travels: website -> server. The "create announcement/event" form the admin fills in.
/// <summary>Payload the admin sends to create an announcement or event.</summary>
